    ...
    public class Proxy
    {
        ...
        public async Task<IEnumerable<T>> GetAsync<T>(string path, List<Uri> redirectUriList = null)
        {
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri(_proxyBaseUrl, path)
            };
            ...
            switch (result.StatusCode)
            {
                ...
                case HttpStatusCode.RedirectMethod:
                    if (result.Headers.Location != null)
                    {
                        ...
                        return await GetAsync<T>(result.Headers.Location.PathAndQuery, redirectUriList);
                    }
        ...
        public async Task<T> GetSingleAsync<T>(string path, List<Uri> redirectUriList = null)
        {
            ...
            switch (result.StatusCode)
            {
                ...
                case HttpStatusCode.RedirectMethod:
                    ...
                    {
                        redirectUriList.Add(result.Headers.Location);
                        return await GetSingleAsync<T>(result.Headers.Location.PathAndQuery, redirectUriList);
                    }
                    throw new WebApiException("Redirect without Location provided", result.StatusCode);
        ...
        public async Task<T> PostAsync<T>(T model, string path, List<Uri> redirectUriList = null)
        {
            ...
            switch (result.StatusCode)
            {
                ...
                case HttpStatusCode.RedirectMethod:
                    ...
                    {
                        redirectUriList.Add(result.Headers.Location);
                        return await PostAsync<T>(model, result.Headers.Location.PathAndQuery, redirectUriList);
                    }
                    throw new WebApiException("Redirect without Location provided", result.StatusCode);
        ...
        public async Task<T> PatchAsync<T>(T model, string path, List<Uri> redirectUriList = null)
        {
            var request = new HttpRequestMessage
            {
        ...
        public async Task DeleteAsync(string path, List<Uri> redirectUriList = null)
        {
            ...
            switch (result.StatusCode)
            {
                ...
                case HttpStatusCode.RedirectMethod:
                    ...
                    {
                        redirectUriList.Add(result.Headers.Location);
                        await DeleteAsync(result.Headers.Location.PathAndQuery, redirectUriList);
                        return;
                    }
                    throw new WebApiException("Redirect without Location provided", result.StatusCode);
